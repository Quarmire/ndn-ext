...
/// Big-endian NonNegativeInteger encoding (Nonce, lifetimes, etc.).
...
/// Synthetic Data with a 32-byte DigestSha256 signature value.
...
pub struct TlvNode {
    ...
    /// Offset just past the value bytes.
    pub end_byte: usize,
    pub value_hex: String,
    /// Set when the value bytes are printable ASCII.
...
/// Parse hex with or without spaces.
