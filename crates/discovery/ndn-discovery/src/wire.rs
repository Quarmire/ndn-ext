//! TLV encode/decode helpers for discovery packet builders.
...
/// Parsed Interest without `ParametersSha256DigestComponent` validation —
/// discovery protocols trust the link.
...
/// Return inner fragment of an LP packet, or `raw` if not LP-framed.
